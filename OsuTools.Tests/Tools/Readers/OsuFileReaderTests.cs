...
namespace OsuTools.Tests.Tools.Readers {
    ...
    public class OsuFileReaderTests {
        ...
        public void BeatmapVersionTooOldTest() {
            ...
            Assert.Throws<OsuFileVersionTooOldException>(() => OsuFileReader.Read(filePath));
        }
        ...
        public void BeatmapVersionBadFormatedTest() {
            ...
            Assert.Throws<OsuFileFormatException>(() => OsuFileReader.Read(filePath));
        }
        ...
        public void ParsingASingleFileTest() {
            ...
            Beatmap beatmap = OsuFileReader.Read(filePath);

            // General
            Assert.Equal(Ruleset.Standard, beatmap.Ruleset);
            Assert.Equal("b1fab265237db340c861047f10d0183a", beatmap.Hash);
